...
export const Methodology: React.FC<MethodologyProps> = ({ onClose, onExploreModule }) => {
  ...
  return (
    <div className={`w-full min-h-screen py-8 sm:py-10 px-4 sm:px-6 lg:px-8 transition-colors ${
      ...
      <div className="max-w-6xl mx-auto space-y-9">
        ...
        <div className="space-y-3 max-w-4xl">
          ...
          <h1 className="text-3xl sm:text-[3.6rem] font-black tracking-[-.045em] leading-[.96]">
            Bagaimana Chemly Bekerja di Balik Layar.
          </h1>

          <p className="max-w-2xl text-[13px] sm:text-[15px] text-zinc-400 leading-6">
