      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 md:p-6 overflow-hidden">
          ...
          <motion.div
            ...
            className={`relative w-full max-w-3xl max-h-[86vh] flex flex-col rounded-[28px] border shadow-[0_35px_100px_rgba(0,0,0,.55)] overflow-hidden ${
              isDark 
          ...
          >
            ...
            <div className={`px-5 sm:px-6 py-3 border-b flex items-center gap-1.5 overflow-x-auto ${
