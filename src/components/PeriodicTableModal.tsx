...
export const PeriodicTableModal: React.FC<PeriodicTableModalProps> = ({
  ...
  useEffect(() => {
    ...
    setViewMode(isMobile ? "table" : "table");
  }, []);
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 md:p-6 overflow-hidden select-none">
        ...
        >
          ...
          <div className="flex-1 flex flex-col lg:flex-row overflow-hidden relative">
            ...
            {viewMode === "table" && (
              <div className="flex-1 p-2 sm:p-4 overflow-x-auto overflow-y-auto overscroll-contain relative touch-pan-x touch-pan-y scrollbar-none" style={{ WebkitOverflowScrolling: "touch" }}>
                <div className="flex sm:hidden items-center justify-between px-1 pb-2 text-[9px] font-mono uppercase tracking-[.14em] text-zinc-500">
                  <span>Periodic matrix</span>
                  <span className="text-sky-400">← geser →</span>
                </div>
                <div className="min-w-[880px] pb-4 pr-3">
                  <div
                    className="grid auto-rows-fr relative gap-1 select-none will-change-transform"
                    style={{
                    ...
                    {PERIODIC_ELEMENTS.map((el) => {
                      ...
                      return (
                        <div
                          ...
                          className={`relative aspect-square rounded-xl border p-1 flex flex-col justify-between cursor-pointer transition-all duration-200 ease-out backdrop-blur-md ${
                            isInspected
                              ? isDark
